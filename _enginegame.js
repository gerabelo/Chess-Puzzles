...
function engineGame(options) {
    ...
    function permanenciaPGN(pgn) {
        ...
        if (playerColor == 'white') {
            gameDescription.white = '[White "Stockfish '+(parseInt($('#skillLevel1').val())*73+1100)+'"]';
            gameDescription.black = '[Black "Stockfish '+(parseInt($('#skillLevel2').val())*73+1100)+'"]';
        } else {
            gameDescription.white = '[White "Stockfish '+(parseInt($('#skillLevel2').val())*73+1100)+'"]';
            gameDescription.black = '[Black "Stockfish '+(parseInt($('#skillLevel1').val())*73+1100)+'"]';
        }
